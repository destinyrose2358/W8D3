...
questions = Questions.create([{text: "Who is teh best?", poll_id: 1}, {text: "Well does he?", poll_id: 2}])

answer_choices = AnswerChoices.create([{question_id: 1, text: "its me"}, {question_id: 1, text: "anyone but me"},
